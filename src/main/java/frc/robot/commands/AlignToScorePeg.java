...
public final class AlignToScorePeg extends CommandBase {
    ...
    public AlignToScorePeg(Limelight limelight, SwerveDrive swerveDrive) {
    ...
    public void execute() {
        m_limelight.switchPipeline(1);
        if(m_limelight.getTX() != 0 && m_limelight.getPipeline()==1) {
